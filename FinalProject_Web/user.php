    ...
    <div class="col-md-6">
        ...
        <div class="block-web success-box">
            ...
            <div class="porlets-content">
                ...
                <p>Pertanyaan dan Informasi, silahkan kontak Panitia di 031234567890 !</p>
            </div>
        </div>
            ...
            <div class="porlets-content">
                ...
                <div class="table-responsive">
                    <table class="table table-invoice">
                        ...
                        <tr>
                            <td><button><a href="print.php">PRINT</a></button></td>
                        </tr>
                    </table>
        ...
        <div class="col-md-12 konfirm">
            <form role="form" action="transfer.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label>Nama Bank - Atas nama rekening (Contoh : BRI - Atas nama Baitun)</label>
                    <div>
